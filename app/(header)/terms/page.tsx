...
const TermsAndConditionsPage: FC = () => {
  return (
    <div id="doc">
      ...
      <p>Welcome to Trophy Hunt Template!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Hartaithan&apos;s Website, located at&nbsp;
        <a href="https://trophy-hunt-template.vercel.app" target="_blank">
          https://trophy-hunt-template.vercel.app
        </a>
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Trophy Hunt Template if you do not
      ...
      <h3>Cookies</h3>
      <p>
        We employ the use of cookies. By accessing Trophy Hunt Template, you
        agreed to use cookies in agreement with the our&nbsp;
        <a
          href="https://trophy-hunt-template.vercel.app/privacy"
          target="_blank">
          Privacy Policy.
        </a>
      </p>
      ...
      <h3>License</h3>
      <p>
        Unless otherwise stated, Hartaithan and/or its licensors own the
        intellectual property rights for all material on Trophy Hunt Template.
        All intellectual property rights are reserved. You may access this from
        Trophy Hunt Template for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Trophy Hunt Template</li>
        <li>Sell, rent or sub-license material from Trophy Hunt Template</li>
        <li>Reproduce, duplicate or copy material from Trophy Hunt Template</li>
        <li>Redistribute content from Trophy Hunt Template</li>
      </ul>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Hartaithan does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Hartaithan,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Hartaithan shall not be
      ...
      <p>
        Hartaithan reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Hartaithan a non-exclusive license to use, reproduce,
      ...
      <ul>
        ...
        <li>online directory distributors;</li> <li>internet portals;</li>
      ...
      <p>
        ...
        the hyperlink compensates the absence of Hartaithan; and (d) the link is
      ...
      <p>
        ...
        e-mail to Hartaithan. Please include your name, your organization name,
      ...
      <p>
        No use of Hartaithan&apos;s logo or other artwork will be allowed for
